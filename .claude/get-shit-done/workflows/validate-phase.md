...
```
Agent(
  prompt="Read /home/ziyad/kids-AZ/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/ziyad/kids-AZ/.claude/get-shit-done/templates/VALIDATION.md`
