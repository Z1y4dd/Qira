...
```bash
INIT=$(node "/home/ziyad/kids-AZ/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/ziyad/kids-AZ/.claude/get-shit-done/templates/spec.md.
