...
```bash
INIT=$(node "/home/ziyad/kids-AZ/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/ziyad/kids-AZ/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
