...
- **Global scope**: `/home/ziyad/kids-AZ/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/ziyad/kids-AZ/.claude/notes/`)
...
2. Glob `/home/ziyad/kids-AZ/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/ziyad/kids-AZ/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/ziyad/kids-AZ/.claude/notes/` — works in any directory
