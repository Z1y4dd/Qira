...
Reference full template: `/home/ziyad/kids-AZ/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/ziyad/kids-AZ/.claude/get-shit-done/templates/state.md`.
