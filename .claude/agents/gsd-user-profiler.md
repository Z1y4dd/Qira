...
<reference>
@/home/ziyad/kids-AZ/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/ziyad/kids-AZ/.claude/get-shit-done/references/user-profiling.md` to load:
