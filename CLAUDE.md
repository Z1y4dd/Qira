...
**Core Value:** A child reads a passage at their actual level and we can tell whether they understood it. Everything else (auth, profiles, dashboards, gamification, content scale) exists to serve this one loop.
